...
// wintermute eagle rev 01.29.21 Robby Glen Garner
// (C) 1999-2021 Robby Glen Garner and Paco Xander Nathan
...
public class wintermute extends Applet implements Runnable {
  ...
  public void init (String[] args) {
    ...
    if (inApplet) {
      ...
      frame.setTitle("wintermute console");
	...
	hal.addDocument("file:///home/robby/earl/sponge.txt");
  ...
  public static void sendLine () {
    ...
    else response = stringreplace(response, "[unknown]", halspeaks);
...
//    	} while (curtime < endtime);
 ...
 public static String getFortune() throws IOException {
	...
	System.out.println("Fortune Told.\n");
...
public static String execCmd(String cmd) {
  ...
  public static void main (String[] args) {
    ...
    wintermute aleph = new wintermute();
    aleph.init(args);
    aleph.start();
  }
}
