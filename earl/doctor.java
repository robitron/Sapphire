// doctor rev 05/20/11 RGG
// earl eagle rev 07.23.13 Robby Glen Garner 
// (C) 1999-2013 Robby Glen Garner and Paco Xander Nathan
...
public class doctor extends Applet implements Runnable {
  ...
  private static int speak = 1;  //to speak or not
  ...
  public void init (String[] args) {
    ...
    grammar = new Grammar();
    eagle = new EARL(grammar, true, "doctor.erl");
    ...
    try {
      ...
      //Font font2 = new Font("Courier", Font.COURIER, 18);
      //input.setFont(font2);
	...
	hal.addDocument("file:///earl/sponge.txt");
    ...
    public static void setupDatabaseConnection()
    {
       ...
       String databaseURL = "jdbc:mysql:///wn_pro_mysql";
       String user = "root";
       String password = "jehova";
       ...
       try
       {
        ...
        // connect to database
        myConnection = DriverManager.getConnection( databaseURL, user, password );
...
//     }
	 ...
	 //System.out.println(StimRez + " | " + response);

	 //System.out.println(last_said + " " + stimulus);
    ...
    if (stimulus.indexOf("fortune") != -1) response = getFortune();
    if (stimulus.startsWith("wiki")) wiki(stimulus);
    if (stimulus.startsWith("lookup ")) mathematics(stimulus.substring(7));
    
//    String fq = formQuest(stimulus); 
//    if (!fq.equals("")) response = fq;

//     StimRez = Stimrez_Response(lowput);
//     if ((StimRez != null) && !StimRez.equals("")) {
//	 if (!StimRez.equals(""))
//		 {
//			response = StimRez;
//		 }
 ...
 public static String getFortune() {
  ...
  public static void Save_Stimrez(String stimulus, String response)
  {
    ...
    public static void updateRelate(String inputline)
    {
        ...
        String updateNewRelationSQL = 
                    "UPDATE Relate " +
                    "SET  " +
                    "right_hand = '" + rhand + "' where left_hand = '" + lhand + "';";       
    ...
    public static String getRelate(String inputline)
    {
        ...
        if (gotIt != -1) {
            ...
            String selectRelateSQL = 
                    "SELECT left_hand, pivot, right_hand " +
                    "FROM Relate " +
                    "WHERE " +
                    "left_hand = '" + rhand + "';";       
  ...
  public static void recordLine (String line) {
    ...
    record.setSelectionEnd(text.length());
      ...
      if (speak==1) {
      try {
	       P1 = Runtime.getRuntime().exec( "/usr/bin/say -v Bruce \" " + line + "\"" );
            ...
            public void run() {
                ...
                try {
                     ...
                     if (!latch2.equals("open") && (silence > 60)) {
                         //recordLine("Are you still there?");
                         silence = 0;
                         latch2 = "open";
                     }
